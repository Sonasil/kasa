...
"[project]/app/profile/settings/phone/otp/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PhoneOtpPage() {
    ...
    const [phoneE164, setPhoneE164] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [resendCooldown, setResendCooldown] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(60);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PhoneOtpPage.useEffect": ()=>{
            const unsub = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"].onAuthStateChanged({
                "PhoneOtpPage.useEffect.unsub": (user)=>{
                    if (!user) {
                        router.replace("/login");
                    }
                }
            }["PhoneOtpPage.useEffect.unsub"]);
            return ({
                "PhoneOtpPage.useEffect": ()=>unsub()
            })["PhoneOtpPage.useEffect"];
        }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PhoneOtpPage.useEffect": ()=>{
            ...
            const id = setInterval({
                "PhoneOtpPage.useEffect.id": ()=>setResendCooldown({
                        "PhoneOtpPage.useEffect.id": (c)=>c > 0 ? c - 1 : 0
                    }["PhoneOtpPage.useEffect.id"])
            }["PhoneOtpPage.useEffect.id"], 1000);
            return ({
                "PhoneOtpPage.useEffect": ()=>clearInterval(id)
            })["PhoneOtpPage.useEffect"];
        }
    }["PhoneOtpPage.useEffect"], [
        resendCooldown
    ...
    const isOtpComplete = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PhoneOtpPage.useMemo[isOtpComplete]": ()=>otp.join("").length === 6
    }["PhoneOtpPage.useMemo[isOtpComplete]"], [
        otp
    ]);
    ...
    const verifyOtp = async ()=>{
        ...
        try {
            const credential = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PhoneAuthProvider"].credential(verificationId, code);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["linkWithCredential"])(user, credential);
            await user.reload();
...
_s(PhoneOtpPage, "SB2ui2FErcYSxpJ5gPsL9AgCiCE=", false, function() {
    return [
...
_c = PhoneOtpPage;
var _c;
__turbopack_context__.k.register(_c, "PhoneOtpPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_acddc462._.js.map