...
function SettingsPage() {
    ...
    const [profileEmail, setProfileEmail] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const [currency, setCurrency] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("TRY");
    const [language, setLanguage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("en");
    // Dialog states
    const [currencyDialogOpen, setCurrencyDialogOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [languageDialogOpen, setLanguageDialogOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [permissionDialogOpen, setPermissionDialogOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [selectedPermission, setSelectedPermission] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const persistSettings = (next)=>{
        if (!uid) return;
        // debounce writes to avoid spamming Firestore when user taps quickly
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SettingsPage.useEffect": ()=>{
            ...
            const unsubAuth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onAuthStateChanged"])(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"], {
                "SettingsPage.useEffect.unsubAuth": (user)=>{
                    if (unsubUserDoc) {
                        try {
                            unsubUserDoc();
                        } catch  {}
                    ...
                    // Realtime settings from users/{uid}
                    ...
                    unsubUserDoc = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["onSnapshot"])(ref, {
                        "SettingsPage.useEffect.unsubAuth": (snap)=>{
                            const data = snap.data() || {};
                            const s = data.settings || {};
                            setNotificationsEnabled(typeof s.notificationsEnabled === "boolean" ? s.notificationsEnabled : true);
                            setCurrency(typeof s.currency === "string" ? s.currency : "TRY");
                            setLanguage(typeof s.language === "string" ? s.language : "en");
                            // allow Firestore to override profile fields if you store them there
                            if (typeof data.displayName === "string") setProfileName(data.displayName);
                            if (typeof data.email === "string") setProfileEmail(data.email);
                            setLoading(false);
                        }
                    }["SettingsPage.useEffect.unsubAuth"], {
                        "SettingsPage.useEffect.unsubAuth": (err)=>{
...
_s(SettingsPage, "sjVPEqayGgb/PJjiEy4it8i3aZM=", false, function() {
    return [
...
//# sourceMappingURL=_ba79c156._.js.map