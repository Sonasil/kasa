    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (code === "auth/email-already-in-use") {
                ...
                setErrors((prev)=>({
                        ...prev,
                        password: t("passwordTooWeak")
                    }));
            } else {
                // Fallback: keep UI unchanged, surface minimal feedback
                setErrors((prev)=>({
                        ...prev,
                        email: prev.email || t("createFailed")
                    }));
            }
        } finally{
            setLoading(false);
...
_s(RegisterPage, "ShHnEajGl3OFe5t4FAR3SrCRyy0=", false, function() {
    return [
...
//# sourceMappingURL=_49791518._.js.map